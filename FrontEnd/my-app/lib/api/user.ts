...
const mockRecentSubmissions: Submission[] = [
  {
    ...
    approvedBy: "GA123...",
    rejectionReason: "Approved after final validation pass.",
  },
  {
    id: "submission-2",
    questId: "active-2",
