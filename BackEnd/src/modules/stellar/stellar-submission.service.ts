...
/**
 * Handles Soroban contract submission — building, simulating, signing, and
 * submitting `approve_submission` transactions to the configured earn-quest
 * contract.
 *
 * Dependencies on Horizon / RPC servers and network passphrase are provided
  ...
  async approveSubmission(
    ...
    return this.tracing.trace(
      ...
      async (span) => {
        ...
        const accountResponse = await horizon.loadAccount(sourcePubKey);
